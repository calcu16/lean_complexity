...
begin
  ...
  { intros hab hac,
    ...
    { rw [hab.left, hac.left],
      ...
      simp,
      have h: x_f.uses 0 = 0,
      { rw [← reduction_step_uses hab.right.right, shift_uses_zero] },
      cases shift_of_uses h with x' hx,
      use x',
    ...
    { rw [hab.left, hac.left],
      ...
      simp,
      have h: y_f.uses 0 = 0,
      { rw [← reduction_step_uses hac.right.right, shift_uses_zero] },
      cases shift_of_uses h with y' hy,
      use y',
